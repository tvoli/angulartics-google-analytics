  ...
  function eventTrack (action, properties) {
    ...
    if (window.ga) {
      ...
      var eventOptions = {
        ...
        eventPrice: properties.price,
        eventCoupon: properties.coupon,
        eventRevenue: properties.revenue,
        eventStep: properties.step,
        eventQuantity: properties.quantity,
      ...
      _gaq.push(['_trackEvent', properties.category, action, properties.label, properties.id, properties.price, properties.coupon, properties.revenue, properties.step, properties.quantity, properties.value, properties.noninteraction]);
    }
